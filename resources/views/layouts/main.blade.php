...
<script src="https://www.google.com/recaptcha/api.js" async defer></script>
    ...
    <body>
        ...
        <div class="row justify-content-md-center">
            <div class="col-md-8">
                <div class="card mt-2">
                    <img src="{{ asset ('assets/images/header.png') }}" alt="fluid">
                    <div class="card-header">
                        <div class="card-title"><h1 style="font-family:verdana">Internet Cepat dan Aman</p></div>
                    </div>
                    <div class="card-body">
                        <p style="font-size:23px;">Nikmati kemudahan mengakses jaringan internet unlimited cepat dan aman.</p>
                    </div>
                </div>
            </div>
        </div>
