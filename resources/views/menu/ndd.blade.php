...
@section('content')
<title>NDD.NET - Voucher Wifi Cibungbulang</title>
<style>
.center {
    display: block;
    margin-left: auto;
            ...
            <div class="card mb-3">
               <div class="card-body">
                <div class="card-header ">
                    <img src="{{ asset ('assets/images/logo-net/ndd.net.png') }}" alt="fluid" class="center">
                </div>
                <div class="card-content">
                    <div class="card-body">
                        <p class="card-text">Voucher Internet Murah dan Unlimited untuk sekitaran Kp. Cijujung</p>
                    </div>
